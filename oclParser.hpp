...
#define CL_DEVICE_preferred_vector_width_char            CL_DEVICE_PREFERRED_VECTOR_WIDTH_CHAR            
#define CL_DEVICE_preferred_vector_width_short           CL_DEVICE_PREFERRED_VECTOR_WIDTH_SHORT           
#define CL_DEVICE_preferred_vector_width_int             CL_DEVICE_PREFERRED_VECTOR_WIDTH_INT             
#define CL_DEVICE_preferred_vector_width_long            CL_DEVICE_PREFERRED_VECTOR_WIDTH_LONG            
#define CL_DEVICE_preferred_vector_width_float           CL_DEVICE_PREFERRED_VECTOR_WIDTH_FLOAT           
#define CL_DEVICE_preferred_vector_width_double          CL_DEVICE_PREFERRED_VECTOR_WIDTH_DOUBLE          
...
#define CL_DEVICE_profiling_timer_resolution             CL_DEVICE_PROFILING_TIMER_RESOLUTION             
...
#define CL_DEVICE_preferred_vector_width_half            CL_DEVICE_PREFERRED_VECTOR_WIDTH_HALF            
#define CL_DEVICE_host_unified_memory                    CL_DEVICE_HOST_UNIFIED_MEMORY                       /* deprecated */
...
#define CL_DEVICE_native_vector_width_double             CL_DEVICE_NATIVE_VECTOR_WIDTH_DOUBLE             
...
#define CL_DEVICE_preferred_interop_user_sync            CL_DEVICE_PREFERRED_INTEROP_USER_SYNC            
...
#define CL_DEVICE_image_base_address_alignment           CL_DEVICE_IMAGE_BASE_ADDRESS_ALIGNMENT           
...
#define CL_DEVICE_queue_on_device_properties             CL_DEVICE_QUEUE_ON_DEVICE_PROPERTIES             
#define CL_DEVICE_queue_on_device_preferred_size         CL_DEVICE_QUEUE_ON_DEVICE_PREFERRED_SIZE         
...
#define CL_DEVICE_global_variable_preferred_total_size   CL_DEVICE_GLOBAL_VARIABLE_PREFERRED_TOTAL_SIZE   
#define CL_DEVICE_max_pipe_args                          CL_DEVICE_MAX_PIPE_ARGS                          
#define CL_DEVICE_pipe_max_active_reservations           CL_DEVICE_PIPE_MAX_ACTIVE_RESERVATIONS           
#define CL_DEVICE_pipe_max_packet_size                   CL_DEVICE_PIPE_MAX_PACKET_SIZE                   
#define CL_DEVICE_preferred_platform_atomic_alignment    CL_DEVICE_PREFERRED_PLATFORM_ATOMIC_ALIGNMENT    
#define CL_DEVICE_preferred_global_atomic_alignment      CL_DEVICE_PREFERRED_GLOBAL_ATOMIC_ALIGNMENT      
#define CL_DEVICE_preferred_local_atomic_alignment       CL_DEVICE_PREFERRED_LOCAL_ATOMIC_ALIGNMENT       
#define CL_DEVICE_il_version                             CL_DEVICE_IL_VERSION                             
#define CL_DEVICE_max_num_sub_groups                     CL_DEVICE_MAX_NUM_SUB_GROUPS                     
#define CL_DEVICE_sub_group_independent_forward_progress CL_DEVICE_SUB_GROUP_INDEPENDENT_FORWARD_PROGRESS 

#define DEFINE_VAL(str, name, val) dcl_##str m_##name {CL_DEVICE_##name, #name, val};
struct device_data {
  ...
  DEFINE_VAL(string, extensions, 0)
  ...
  DEFINE_VAL(string, name, 0)
  DEFINE_VAL(string, opencl_c_version, 0)
  ...
  DEFINE_VAL(string, profile, 0)
  DEFINE_VAL(string, vendor_id, 0)
  DEFINE_VAL(string, vendor, 0)
  DEFINE_VAL(string, version, 0)
